...
public class client extends javax.swing.JFrame {
    ...
    void m2(int d2, String d3, int d4, int d5, String d6, int d7) {
        String response = "";
        try {
            response = ifc.tambah_tgn(d2, d3, d4, d5, d6, d7);
            JOptionPane.showMessageDialog(null, response);
        } catch (IOException e) {
            JOptionPane.showMessageDialog(null, "Terjadi kesalahan!\n" + e, "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    void m5(int d, String g, int f) {
        ...
        try {
            if (d == 0) {
                List<bayar> list = (List) ifc.getbyr(d, g, f);
                for (bayar s : list) {
                    String KAMAR = Integer.toString(s.getKamar());
                    String NAMA = s.getNama();
    ...
    void get_kamar_tb(int a, int b) {
        ...
        try {
            List<kamar> list = (List) ifc.getkmr3(a, b);
            for (kamar s : list) {
    ...
    void get_bln_cmb1(int d) {
        ...
        try {
            List<bulan> list = (List) ifc.getbln1(d);
            for (bulan s : list) {
                id_bln1 = s.getId_bln();
    ...
    void get_bln_cmb2() {
        ...
        try {
            List<bulan> list = (List) ifc.getbln2();
            for (bulan s : list) {
                String bulan = s.getNama_bln();
    ...
    void get_lantai_cmb() {
        ...
        try {
            List<lantai> list = (List) ifc.getkmr2();
    ...
    void get_kamar_cmb() {
        ...
        try {
            List<kamar> list = (List) ifc.getkmr1();
    ...
    public static void main(String args[]) throws RemoteException, NotBoundException, MalformedURLException {
        ...
        try {
            ifc = (interfaces) Naming.lookup("rmi://localhost:2020/wtf");
